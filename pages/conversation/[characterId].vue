                ...
                <div v-if="conversations.length != 0" class="w-full space-y-5">
                  ...
                  >
                    <NuxtLink :to="`/conversation/${conversation.id}`">
                      ...
                      <p>— {{ conversation?.characterName }}</p>
                    </NuxtLink>
                  </div>
                </div>
                <div v-else>
...
const conversationsCash = computed(() => store.characterConversationsCash);
      ...
      <div class="w-full max-w-screen-xl md:px-5">
        <div>
          ...
          <div class="gap-5 max-md:space-y-8 md:flex">
            ...
            >
              <div class="h-full w-full overflow-y-auto">
                <div v-if="true" class="w-full space-y-5">
                  <div
                    v-for="conversation in conversationsCash[index]
...
onMounted(async () => {
  ...
  index.value = conversationsCash.value.findIndex(
